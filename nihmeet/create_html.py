...
def generate_html_report(filepath, output_path="index.html"):
    ...
    <body>
        ...
        <h1 class="text-center mb-4" style="font-size: 2.5rem; color: #4CAF50; font-weight: bold;">NIH Federal Register Closed Meeting Tracker  (stopped updating on 06-13-2025)</h1>
